...
<section class="flex flex-col items-center self-stretch justify-center py-8 text-black bg-white lg:py-20">
  <div class="flex flex-col md:flex-row p-10 max-w-full bg-yellow-50 w-[1440px] max-md:px-5 items-center">
    ...
    <div class="min-w-[240px] w-full md:w-[50%] lg:w-[65%] flex items-center">
      ...
      if ($content_001_image_url): ?>
        <img src="<?php echo esc_url($content_001_image_url); ?>"
          ...
          class="object-cover max-sm:min-h-[300px]" />
      <?php else: ?>
