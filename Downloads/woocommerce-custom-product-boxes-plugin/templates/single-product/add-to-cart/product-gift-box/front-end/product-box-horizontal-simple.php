...
<style type="text/css">
	...
	.horizontal_box .gift_box_container .gt_bx_lt .add_box .add_box_hor_simple {background-color: transparent ;}
	.horizontal_box .gift_box_container .add_box .add_box_cta { background: #fff !important;}
	.horizontal_box .gift_box_container .gt_bx_lt .add_box .add_box_hor_simple:hover {background-color: <?php echo filter_var($color_val); ?> !important; color:#fff !important }
	.pd_add_block .pd_addon_btns.pd_addon_active .addon_qty {width: 50%}
		 ...
		 <div class="add_box">
		  <!-- <a href="#!" class="add_box_cta"> <img src="images/remove.png" alt=""> <img src="images/remove_white.png" alt="">Remove Box 1</a> -->
						...
						<div class="gt_item_lmt">
							...
							?>
							<span class="text"><span class="added_item"><span class="extendonsfilledboxcount"><?php echo filter_var($prefileldArraylength); ?></span>/<?php echo filter_var($totalboxQty); ?> </span><?php echo esc_html('Added', 'extendons-woocommerce-product-boxes'); ?></span>
						</div>
