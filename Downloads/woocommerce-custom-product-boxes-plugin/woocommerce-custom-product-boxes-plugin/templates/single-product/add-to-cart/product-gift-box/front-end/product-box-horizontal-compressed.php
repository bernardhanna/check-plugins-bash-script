...
?>    
<!-- <style type="text/css">
	.gt_box_tab .box_tb_list:hover{ background-color: <?php echo filter_var($color_val); ?>; border-color:<?php echo filter_var($color_val); ?>; color :#ffff !important}
</style> -->
<style type="text/css">
...
/*    .horizontal_box .gt_box_tab .box_tb.active_tab .box_tb_list{background-color: <?php echo filter_var($color_val); ?>; border-color:<?php echo filter_var($color_val); ?>;}*/
	.horizontal_box .gt_box_tab .box_tb.active_tab .box_tb_list .gt_qt{color: <?php echo filter_var($color_val); ?>; border-color: transparent !important;}
	.pd_add_block .pd_addon_btns .add_btn {width:auto;}
/*    .horizontal_box .gift_box_container .gt_bx_lt .add_box  {background-color: black ;}*/
	.horizontal_box .gift_box_container .add_box .add_box_cta { background: #fff !important;}
	.horizontal_box .gift_box_container .gt_bx_lt .add_box :hover {background-color: <?php echo filter_var($color_val); ?> !important; color:#fff !important }
	.pd_add_block .pd_addon_btns .add_btn :hover { background-color: <?php echo filter_var($color_val); ?> ; color:#fff !important };
	.product-type-wooextmm { width:50%; margin:10px auto; }
/*    .horizontal_box .gift_box_container .gt_bx_lt .add_box :hover {}*/
...
if ('yes' != $add_new_box_quantity) { 
	...
	?>
<style type="text/css">
.horizontal_box .gt_bx_rt { width:100% !important; }
.horizontal_box .gt_bx_rt { display: block; }
.horizontal_box .gift_box_container {display: block};
			...
			<div class="gt_bx_rt" color_val = <?php echo filter_var($color_val); ?> >
				<div id="gift_box_0" data-box-count='0' class="product_gift_box active_bx_dtl">
					...
					<div class="reset_gt_box resp">
						<a href="#" class="clear_cta">
						<?php 
						echo filter_var($circled_x);
						echo esc_html__('Clear All Items', 'extendons-woocommerce-product-boxes'); 
						?>
						 </a>
					</div>
				</div>
				...
				<div class="pd_add_block">
					...
					<div class="pd_dtl">
					   ...
					   <span class="pd_price"><span class="price">
						 ...
						 <?php if ('yes' == $_mm_enabledescription) { ?>
